...
namespace Cliente
{
    class Eventos_Camara
    {
        ...
        public void IniciarCapturaVideo(string directorio, string sala)
        {
            ...
            Eventos.Escribir("El Video del " + sala + " ha empezado a grabarse.");
            Eventos.Escribir("El Video del " + sala + " se grabara en la ruta: " + rutaGuardarVideo);
        }
        ...
        public void TomarSnapShot(string directorio, string sala)
        {
            ...
            Eventos.Escribir("La imagen del " + sala + " ha sido guardada en la ruta: " + rutaGuardarImagen);
        }
        ...
        public void DetenerCapturaVideo(string sala)
        {
            ...
            else
            {
                ...
                Eventos.Escribir("El Video del " + sala + " ha sido detenido.");
            }
        }
        ...
        public void Zoom(string zoom, string sala)
        {
            ...
            {
                EventoZoom.In();
                Eventos.Escribir("El zoom de la camara del " + sala + " ha sido aumentado a : " + EventoZoom.Factor.ToString(CultureInfo.InvariantCulture));
            }
            if(zoom == "Disminuir")
            {
                EventoZoom.Out();
                Eventos.Escribir("El zoom de la camara del " + sala + " ha sido disminuido a :"  + EventoZoom.Factor.ToString(CultureInfo.InvariantCulture));
            }
            if (zoom == "Default")
            {
                EventoZoom.Default();
                Eventos.Escribir("El zoom de la camara del " + sala + " ha retornado a :" + EventoZoom.Factor.ToString(CultureInfo.InvariantCulture));
            }
        }
