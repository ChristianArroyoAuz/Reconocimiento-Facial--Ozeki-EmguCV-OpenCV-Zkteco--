...
namespace Cliente
{
    class Mensajes
    {
        //Variable publica creada para enviar los eventos generados al formulario principal
        public string informacionEvento;
        
        //Metodo que me permite recibir los mensajes de los eventos
        public Mensajes(string mensajeRecibidoEvento)
        {
            //Se carga en la variable local el mensaje del evento recibido
            informacionEvento = mensajeRecibidoEvento;
        }
    }
}